...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if self.ant is insect and not self.ant.is_container:
                if self.ant.is_queen:
                    self.ant = insect
                    return
            elif self.ant is insect and self.ant.is_container:
                if self.ant.contained_ant.is_queen:
                    self.ant.contained_ant = self.ant.contained_ant      # END Problem 13
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 7
        #return self.place.ant.blocks_path and self.place.ant
        if not self.place.ant is None:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        place = self.place
        i = 0
        while place.bees == [] or i < self.min_range:
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        if len(self.place.bees) != 0 and self.digesting <= 0:
            target = random.choice(self.place.bees)
            target.armor = 0
            self.place.remove_insect(target)
...
class NinjaAnt(Ant):
    ...
    def action(self, colony):
        ...
        for b in self.place.bees[:]:
        #    def reduce_armor(self, amount):
        #        return Insect.reduce_armor(b, damage)
            b.armor -= self.damage
            if b.armor <= 0:
                self.place.remove_insect(b)
        # END Problem 7
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return self.contained_ant == None and not other.is_container
        # END Problem 9
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        ...
        return BodyguardAnt.action(self, colony)
        # END Problem 10
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_watersafe == False:
            ...
            #def reduce_armor(self, amount):
            #    return Insect.reduce_armor(self, insect.armor)
        # END Problem 11
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.is_queen:
            ...
            while place.exit:
                place = place.exit
                if place.ant and place.ant not in self.doubled_ants:
                    place.ant.damage *= 2
                    self.doubled_ants.append(place.ant)
                if place.ant and place.ant.is_container:
                    if place.ant.contained_ant and place.ant.contained_ant not in self.doubled_ants:
                        place.ant.contained_ant.damage *= 2
                        self.doubled_ants.append(place.ant.contained_ant)

        else:
            Insect.reduce_armor(self, amount = self.armor)
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN Problem EC
        "*** YOUR CODE HERE ***"
        if target and target.once_been_scared == False:
            apply_effect()
        # END Problem EC
